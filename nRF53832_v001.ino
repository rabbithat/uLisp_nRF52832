...
MILLIS, SLEEP, NOTE, EDIT, PPRINT, PPRINTALL, PEEK, POKE, PRINT_RB, ENDFUNCTIONS };
...
uint32_t radioBuffer[256];
uint32_t address_radioBuffer;
...
#define NRF52832
  ...
  #define WORKSPACESIZE 992       //1024              /* Cells (8*bytes) */
  #define SYMBOLTABLESIZE 512             /* Bytes */
  uint8_t _end;


#elif defined(NRF52832)
  #define WORKSPACESIZE 4064       //=4096-32              /* Cells (8*bytes) */
  #define SYMBOLTABLESIZE 512             /* Bytes */
  uint8_t _end;
#endif
...
object *fn_print_rb (object *args, object *env) {
  (void) args,(void) env;
  Serial.print("address_radioBuffer=0x");
  Serial.println(address_radioBuffer,HEX);
  return number(address_radioBuffer);
}
...
const char string176[] PROGMEM = "print_rb";
...
void setup () {
  ...
  initsleep();
  Serial.println();
  address_radioBuffer = (uint32_t)radioBuffer;
  Serial.print("address_radioBuffer=");
  Serial.println(address_radioBuffer);
  Serial.print("address_radioBuffer=0x");
  Serial.println(address_radioBuffer,HEX);
